...
const Reservations: React.FC = () => {
  ...
  // Calculate dates for constraints
          ...
          {successMessage ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <input type="date" name="date" value={formData.date} onChange={handleChange} min={minDate} max={maxDate} required className="w-full bg-[#2a2726]/50 border border-stone-600/50 rounded-md px-4 py-3 text-stone-200 placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all" style={{ colorScheme: 'dark' }} />
